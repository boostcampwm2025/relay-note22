...
- **느낀 점**
   - 오늘은 예상보다 훨씬 더 피곤해서 뭘 해도 집중이 안 됐다.
평소처럼 “해야 하니까” 라는 생각으로 무작정 작업을 밀어붙였다면 중간에 멘탈이 더 무너졌을 텐데, AI의 피드백을 참고해서 짧게 낮잠도 자보고, 산책도 해봤다.

   - 결과적으로 몰입 시간은 짧았지만, 집중도는 높았던 순간이 있었다.
특히 ‘나를 돌보는 루틴’을 의식적으로 넣었다는 점에서 하루가 덜 버거웠다.

   - 실행하지 못한 루틴도 있었지만, 그 이유를 납득하고 기록할 수 있었던 것도 좋았다.
"피곤하지만 무조건 하자"보단, "내가 지금 어떤 상태인지"를 먼저 물어보는 습관이 생길 것 같다.
...
```
오늘의 컨디션을 바탕으로 하루 루틴을 조정해 주세요.  
제 상태는 다음과 같습니다:

- 수면 시간: [ex. 3시간 30분]
- 기상 시간: [ex. 오전 5시]
- 식사 상태: [ex. 아침은 안 먹음, 점심은 간단히]
- 현재 에너지 수준(1~10): [ex. 4]
- 기분 상태(한 단어로): [ex. 무기력]
- 해야 할 주요 작업: [ex. 코딩 미션, 블로그 정리]

오늘 어떤 루틴이 도움이 될까요?  
너무 무리하지 않도록 **짧은 루틴 + 회복 방법**도 함께 추천해 주세요.
```

### GPT 답변
```
좋아요. 당신의 컨디션을 토대로 오늘 하루를 무리하지 않으면서도 의미 있게 보내는 루틴을 추천해드릴게요. 우선 입력하신 상태를 예시로 정리해보면 아래와 같습니다:
...
오전 (기상 후 ~ 오전 11시)
시간	활동	설명
5:00~6:00	가벼운 스트레칭 or 산책 (10~15분)	햇빛을 쬐어 멜라토닌 분해 → 졸림 줄이기
6:00~6:30	따뜻한 물 + 간단한 아침	미지근한 물, 바나나 or 삶은 달걀 등 소화 쉬운 음식
6:30~9:00	가장 중요한 일 하나만 (ex. 코딩 미션 중 1단계)	집중력 있는 시간대에 한 가지 작업만 목표로
9:00~9:30	짧은 휴식 + 눈 감고 명상 or 낮잠 (15분)	회복 타임. 숙면 부족 보완

오후 (11시 ~ 17시)
시간	활동	설명
11:00~12:00	가벼운 업무 정리 or 블로그 초안 정리	집중도 낮은 일 위주
12:00~13:00	점심 + 산책 (10분만이라도)	혈당 안정화 & 뇌 환기
13:00~15:00	짧은 코딩 미션 진행 (25분 집중 / 5분 휴식 x 2)	‘포모도로’ 방식으로 체력 분산
15:00~16:00	다시 에너지 떨어지면 낮잠 or 스트레칭	낮잠은 20분 이하, 아니면 더 피곤해짐
16:00~17:00	기분 기록 or 블로그 마무리	하루를 정리하며 감정도 되돌아보기

🌙 저녁 (회복 중심)
가벼운 저녁식사: 소화 잘 되는 음식 위주 (국, 죽, 생선 등)

7시 이후 뇌 과부하 작업 지양: 강한 집중 요구 작업은 미루기

명상/감정 일기 (5분): 오늘 기분을 한 줄로 정리

수면 준비 루틴: 스마트폰 멀리, 조명 낮추기, 따뜻한 물 샤워

🧘 회복 팁
오늘은 “에너지 관리가 우선”입니다.

해야 할 일 100% 달성보다, 50% 에너지로 30%만 하기가 더 중요해요.

무기력할 땐 성취감 하나만 챙기면 충분합니다. 아주 작은 것이라도요.

필요하다면 이 루틴을 구글 캘린더에 넣을 수 있게 정리해줘 라고 요청하시면, 시간대별로 정리해드릴게요.
혹은 기분에 맞는 음악 추천도 도와드릴 수 있습니다.
```
...
- **느낀 점**: 
  - 직접 학습한 후에 설계하고 구현하고 개선한 과제를 퀴즈를 풀어보니 확실히 개념이 더 깊게 자리잡아 문제풀이가 쉬웠다
  - 정확한 키워드를 기억하지 못한 부분이 아쉬웠지만, 학습한 내용을 항상 100% 기억하기는 어려운 것이 당연하다고 생각한다
  - AI를 활용해서 나의 기억을 되짚어보는 방식이 상당히 좋은 효과를 낼 수 있고 간편하게 할 수 있어서 만족스러웠다
  - 단순히 내용을 다시 읽는 것보다 퀴즈 형태로 점검하는 것이 훨씬 효과적이라는 것을 체감했다

- **배운 점**: 
  - 이론 학습 -> 설계 -> 구현 -> 퀴즈 방식의 학습 사이클이 효과적이라는 것을 체감했다
  - 키워드 암기보다는 개념 이해가 우선이지만, 정확한 용어 표현도 중요하다는 균형점을 찾았다
  - 퀴즈를 통해 내가 무엇을 확실히 알고 무엇이 부족한지 객관적으로 파악할 수 있었다
  - 학습 내용을 다양한 형태(객관식, 주관식, OX, 빈칸)로 점검하면 더 입체적인 이해가 가능하다는 것을 알았다
...
### 1. TCP와 UDP의 특징을 비교한 설명으로 올바른 것은?
* 3번

① TCP는 비연결형이고 UDP는 연결형이다<br>
② TCP는 신뢰성을 보장하지 않고 UDP는 신뢰성을 보장한다<br>
③ TCP는 3-way handshake를 사용하고 UDP는 연결 설정 과정이 없다<br>
④ TCP는 브로드캐스트를 지원하고 UDP는 지원하지 않는다

### 2. HTTP Request의 구조에 포함되지 않는 것은?
* 3번 상태 코드는 응답

① 시작 줄 (요청 메서드, URL 경로, HTTP 버전)<br>
② 헤더 (key:value 형식의 부가 정보)<br>
③ 상태 코드 (200, 404 등)<br>
④ 본문 (POST, PUT 등에서 사용되는 데이터)<br>

### 3. 다음 중 실시간성이 중요한 서비스에 적합한 프로토콜은?
* 2번
...
### 4. Echo Server의 역할과 용도를 간단히 설명하세요.
클라이언트로부터 받은 데이터를 그대로 다시 전송하는 서버

네트워크 테스트나 디버깅에 사용

### 5. Client-Server 모델의 장점 2가지와 단점 2가지를 각각 서술하세요.

**장점:**
1. 서버만 업데이트하면 전체 업데이트 가능
2. // 중앙 집중 관리, 확장성, 유지보수 용이 - 키워드가 떠오르질 않았다 ㅎㅎ..

**단점:**
1. 서버에 문제가 생기면 전체 시스템에 영향 끼침
2. // 병목 현상, 단일 장애 지점, 초기 구축 비용 - 얘도..!

---

## ⭕❌ OX 문제

### 6. Session과 Connection은 같은 개념이다. (O / X)
X

### 7. Broadcast는 1:1 통신 방식이다. (O / X)
X

### 8. JSON은 텍스트 기반의 경량 데이터 포맷이다. (O / X)
O

### 9. UDP는 데이터 순서를 보장하고 손실 시 재전송을 수행한다. (O / X)
X
...
### 10. IP 주소에서 서브넷 마스크 255.255.255.0(/24)를 가진 네트워크 192.168.1.0에서 
- 네트워크 주소: 192.168.1.___
- 브로드캐스트 주소: 192.168.1.___
- 사용 가능한 호스트 IP 범위: 192.168.1.___ ~ 192.168.1.___

### 11. 통신 방식 분류
- ________ : 1:1 통신 (웹 브라우징, 이메일 등)
  - 유니캐스트
- ________ : 1:네트워크 내 전체 호스트 통신
  - 브로드캐스트
- ________ : 1:특정 그룹 통신 (스트리밍, 화상회의 등)
  - 멀티캐스트
 </details>
